...
local pluhs = {
    ...
    { dir='~/STUFF/NEOVIM/staline.nvim', config=function()
    ...
    { dir='~/STUFF/NEOVIM/stuff.nvim' },
    { 'tamton-aquib/nvim-market', import="nvim-market.plugins" },
    { dir='~/STUFF/NEOVIM/essentials.nvim', lazy=true },
    ...
    { 'nvim-treesitter/nvim-treesitter', config=cfg_treesitter, commit="bc52938ddde0ff6b3d51ff215d2c66f2e39b7099" },
...
require("lazy").setup({ {pluhs}, {import = "lazydumb"}, }, {
